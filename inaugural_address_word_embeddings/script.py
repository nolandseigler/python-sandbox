...
similar_to_revolution = all_prez_embeddings.most_similar("revolution", topn=20)
# get President Roosevelt sentences
# print(similar_to_freedom)
# print("------------------------------------------------")
# print(similar_to_revolution)
...
rushmore_prez_sentences = get_presidents_sentences(["wahsington", "jefferson", "lincoln", "theodore-roosevelt"])
